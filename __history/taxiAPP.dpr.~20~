...
uses
  ...
  yusou_sharyou_zisseki in 'yusou_sharyou_zisseki.pas' {yusou_sharyou_zissekiForm},
...
//  office in 'office.pas' {officeForm},
  ...
  instruction_listFM in 'instruction_listFM.pas' {FormInstruction_list},
  educationFM in 'educationFM.pas' {FormEducation},
  Unit1 in 'Unit1.pas' {DataModule1: TDataModule},
  DBConnectionModule in 'DBConnectionModule.pas' {DBConnModule: TDataModule};
//  ,
...
begin
  ...
  Application.CreateForm(TDBConnModule, DBConnModule);
...
//  Application.CreateForm(TofficeForm, officeForm);
  ...
  Application.CreateForm(Tyusou_sharyou_zissekiForm, yusou_sharyou_zissekiForm);
  ...
  Application.CreateForm(TFormInstruction_list, FormInstruction_list);
  Application.CreateForm(TFormEducation, FormEducation);
