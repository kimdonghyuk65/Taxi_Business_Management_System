...
uses
  ...
  joumu_reference, urikake_mishu; // Add this line
...
type
  TMyCustomMaskEdit = class(TCustomMaskEdit)
  public
    property EditMask;
  end;
...
var
  ...
  Comp: TComponent;
begin
  business_dayDBEdit.Text := FormatDateTime('YYYY/MM/DD', Now);
