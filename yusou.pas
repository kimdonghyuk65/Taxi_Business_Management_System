...
uses
  ...
  Vcl.ExtCtrls,yusou_nippou, yusou_shukei,yusou_taihi,yusou_joumu_zisseki,yusou_sharyou_zisseki,yusou_joumu_kintai,
  yusou_houkoku, yusou_joumu_tuki, kintai_shukei;
...
type
  TyusouForm = class(TForm)
    ...
    procedure kintai_shukeiButtonClick(Sender: TObject);
...
procedure TyusouForm.joumu_kintaiButtonClick(Sender: TObject);
  ...
  yusou_joumu_kintaiForm: Tyusou_joumu_kintaiForm;
    begin
          yusou_joumu_kintaiForm := Tyusou_joumu_kintaiForm.Create(Application); // Form1 객체를 생성합니다.
  yusou_joumu_kintaiForm.ShowModal; // Form1를 보여줍니다
end;
...
procedure TyusouForm.kintai_shukeiButtonClick(Sender: TObject);
  var
  kintai_shukeiForm: Tkintai_shukeiForm;
    begin
  kintai_shukeiForm := Tkintai_shukeiForm.Create(Application); // Form1 객체를 생성합니다.
  kintai_shukeiForm.ShowModal; // Form1를 보여줍니다.
end;
...
var
  yusou_sharyou_zissekiForm: Tyusou_sharyou_zissekiForm;
    begin
  yusou_sharyou_zissekiForm := Tyusou_sharyou_zissekiForm.Create(Application); // Form1 객체를 생성합니다.
  yusou_sharyou_zissekiForm.ShowModal; // Form1를 보여줍니다.
end;
